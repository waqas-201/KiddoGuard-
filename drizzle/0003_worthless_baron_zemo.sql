...
INSERT INTO `__new_app_table`("packageName", "appName", "versionName", "icon", "isKidSafe", "minAge") SELECT "packageName", "appName", "versionName", "icon", "isKidSafe", "minAge" FROM `app_table`;--> statement-breakpoint
